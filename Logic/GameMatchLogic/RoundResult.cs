...
namespace RocPaSors
{
    internal class RoundResult
    {
        ...
        {
            if (MatchCounter.plyrScoreCounter > MatchCounter.opScoreCounter) bgSource(Assets.Sound("MatchVictory.mp3"));                  
            else if (MatchCounter.plyrScoreCounter < MatchCounter.opScoreCounter)  bgSource(Assets.Sound("MatchDefeat.mp3"));
            else if (MatchCounter.plyrScoreCounter == MatchCounter.opScoreCounter) bgSource(Assets.Sound("MatchTie.mp3"));
        }
