...
namespace RocPaSors
{
    internal class PlayerAction
    {
        ...
        Uri path = Assets.Sound("PlayerAction.mp3");
        GameMatch win;       
        ...
        public void ResetPlayer()
        {
            ...
            if (playerCurrentAction == "none")
            {
                ...
                win.plyrsci.Source = new BitmapImage(Assets.Image("scissors.png"));
                win.plyrrck.Source = new BitmapImage(Assets.Image("fist.png"));
                win.plyrppr.Source = new BitmapImage(Assets.Image("hand-paper.png"));
            }
        }
        public void Scissor_Click(object sender, RoutedEventArgs e)
        {
            if (playerCurrentAction == "none")
            {
                ...
                win.plyrsci.Source = new BitmapImage(Assets.Image("scissors2.png"));
                player.Open(path);
                player.Play();
            }
        ...
        public void Paper_Click(object sender, RoutedEventArgs e)
        {
            if (playerCurrentAction == "none")
            {
                ...
                win.plyrppr.Source = new BitmapImage(Assets.Image("hand-paper2.png"));
                player.Open(path);
                player.Play();
            }
            else if (playerCurrentAction == "paper")
        ...
        public void Rock_Click(object sender, RoutedEventArgs e)
        {
            if (playerCurrentAction == "none")
            {
                ...
                win.plyrrck.Source = new BitmapImage(Assets.Image("fist2.png"));
                player.Open(path);
                player.Play();
            }
            else if (playerCurrentAction == "rock")
